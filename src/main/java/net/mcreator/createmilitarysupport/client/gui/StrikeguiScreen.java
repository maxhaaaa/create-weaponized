...
public class StrikeguiScreen extends AbstractContainerScreen<StrikeguiMenu> {
	...
	public StrikeguiScreen(StrikeguiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("createmilitary_support:textures/screens/strikegui.png");
