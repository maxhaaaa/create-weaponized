...
public class Modelpz_roket<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pz_roket"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rocket = partdefinition.addOrReplaceChild("rocket",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, 1.0F, -7.0F, 6.0F, 4.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
						.addBox(-4.0F, -1.0F, -10.0F, 10.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(25, 0)
						.addBox(-3.0F, 0.0F, -8.0F, 7.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(31, 29)
						.addBox(0.0F, -4.0F, 2.0F, 2.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
