...
public class TestbombRenderer extends EntityRenderer<TestbombEntity> {
	...
	public TestbombRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelbomb(context.bakeLayer(Modelbomb.LAYER_LOCATION));
	}

	@Override
	public void render(TestbombEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(TestbombEntity entity) {
		return texture;
	}
}
