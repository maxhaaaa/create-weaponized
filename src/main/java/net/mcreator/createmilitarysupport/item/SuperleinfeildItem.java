...
public class SuperleinfeildItem extends Item implements GeoItem {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new SuperleinfeildItemRenderer();
	...
	private PlayState idlePredicate(AnimationState event) {
		if (this.transformType != null ? true : false) {
			if (this.animationprocedure.equals("empty")) {
				event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.wunderfeild.idle"));
