...
public class RivetpressTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(0, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RivetpressTileEntity(BlockPos pos, BlockState state) {
		super(CreatemilitarySupportModBlockEntities.RIVETPRESS.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(RivetpressBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RivetpressTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RivetpressTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("rivetpress");
	}
	...
	private final FluidTank fluidTank = new FluidTank(100, fs -> {
