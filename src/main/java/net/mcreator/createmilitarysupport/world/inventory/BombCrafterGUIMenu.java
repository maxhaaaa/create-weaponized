...
package net.mcreator.createmilitarysupport.world.inventory;
...
public class BombCrafterGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BombCrafterGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CreatemilitarySupportModMenus.BOMB_CRAFTER_GUI.get(), id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 43, 62) {
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 61, 35) {
			...
			public boolean mayPlace(ItemStack stack) {
				return CreatemilitarySupportModItems.BOMB_CASING.get() == stack.getItem();
			}
		}));
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 133, 53) {
