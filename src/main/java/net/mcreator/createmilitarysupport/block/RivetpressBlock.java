...
public class RivetpressBlock extends BaseEntityBlock implements EntityBlock {
	...
	public BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
		return CreatemilitarySupportModBlockEntities.RIVETPRESS.get().create(blockPos, blockState);
	}
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		...
		return switch (state.getValue(AXIS)) {
			case X -> box(0, 0, 0, 15, 16, 16);
			case Y -> box(0, 0, 0, 16, 15, 16);
			case Z -> box(0, 0, 1, 16, 16, 16);
		};
	}
	...
	public void onRemove(BlockState state, Level world, BlockPos pos, BlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			BlockEntity blockEntity = world.getBlockEntity(pos);
			if (blockEntity instanceof RivetpressTileEntity be) {
	...
	public int getAnalogOutputSignal(BlockState blockState, Level world, BlockPos pos) {
		...
		if (tileentity instanceof RivetpressTileEntity be)
