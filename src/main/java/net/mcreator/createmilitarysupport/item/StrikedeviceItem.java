...
import net.mcreator.createmilitarysupport.procedures.StrikedeviceRightclickedOnBlockProcedure;
import net.mcreator.createmilitarysupport.item.inventory.StrikedeviceInventoryCapability;
...
public class StrikedeviceItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Strike device");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new StrikedevicenewguiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		StrikedeviceRightclickedOnBlockProcedure.execute(context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer());
		return InteractionResult.SUCCESS;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new StrikedeviceInventoryCapability();
	}
